...
parser.add_argument('--alphaMjj', dest='alphaMjj', type=float, default=0.5, help='linear correlation factor')
...
mgg_pdf_p0 = w.var('CMS_hhbbgg_13TeV_mgg_bkg_par1_cat'+str(opt.cat)).getVal()
mgg_pdf_p1 = w.var('CMS_hhbbgg_13TeV_mgg_bkg_par2_cat'+str(opt.cat)).getVal()
mgg_pdf_p2 = w.var('CMS_hhbbgg_13TeV_mgg_bkg_par3_cat'+str(opt.cat)).getVal()

mjj_pdf_p0 = w.var('CMS_hhbbgg_13TeV_mjj_bkg_par1_cat'+str(opt.cat)).getVal()
mjj_pdf_p1 = w.var('CMS_hhbbgg_13TeV_mjj_bkg_par2_cat'+str(opt.cat)).getVal()
mjj_pdf_p2 = w.var('CMS_hhbbgg_13TeV_mjj_bkg_par3_cat'+str(opt.cat)).getVal()

nW = RooWorkspace('nW')

nW.factory('mjj[70,190]')
...
nW.factory("RooFormulaVar:m_b2_p0_mgg('b2_p0_mgg*b2_p0_mgg*(1+alphaMjj*mjj/190)*(1+alphaMjj*mjj/190) ', {b2_p0_mgg["+str(mgg_pdf_p0)+", -50, 50], mjj, alphaMjj["+str(opt.alphaMjj)+", -3, 3]})")
